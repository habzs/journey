...
import useFetchAllVolunteers from "@/app/hooks/useFetchAllUsers";
...
const AllUsers = () => {
    ...
    const { users, loading, error } = useFetchAllVolunteers(currentUser);
                        ...
                        <TableRow key={user.id}>
                            ...
                            <TableCell className="min-w-40 md:min-w-48">
                                <div className="flex flex-col">
                                    <p className="text-bold text-sm capitalize">{user.mobileNumber}</p>
                                </div>
                            </TableCell>
                            <TableCell>
